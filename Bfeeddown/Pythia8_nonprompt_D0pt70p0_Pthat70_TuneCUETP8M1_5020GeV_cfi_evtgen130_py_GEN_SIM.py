...
# with command line options: Configuration/Generator/python/Pythia8_nonprompt_D0pt70p0_Pthat70_TuneCUETP8M1_5020GeV_cfi_evtgen130.py --fileout file:pp_GENSIM_pthat70.root --eventcontent=RAWSIM --datatier GEN-SIM --step GEN,SIM --conditions auto:mc --processName GENERATOR python_filename pthat70.py --no_exec -n 30000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/Pythia8_nonprompt_D0pt70p0_Pthat70_TuneCUETP8M1_5020GeV_cfi_evtgen130.py nevts:30000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:pp_GENSIM_pthat70.root'),
...
process.D0Daufilter = cms.EDFilter("PythiaMomDauFilter",
    ...
    MomMinPt = cms.untracked.double(70.0),
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('treefile_pthat70.root')
                                                                      )
