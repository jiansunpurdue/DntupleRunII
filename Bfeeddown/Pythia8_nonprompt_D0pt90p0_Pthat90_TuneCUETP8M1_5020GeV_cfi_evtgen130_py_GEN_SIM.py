...
# with command line options: Configuration/Generator/python/Pythia8_nonprompt_D0pt90p0_Pthat90_TuneCUETP8M1_5020GeV_cfi_evtgen130.py --fileout file:pp_GENSIM_pthat90.root --eventcontent=RAWSIM --datatier GEN-SIM --step GEN,SIM --conditions auto:mc --processName GENERATOR python_filename pthat90.py --no_exec -n 30000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/Pythia8_nonprompt_D0pt90p0_Pthat90_TuneCUETP8M1_5020GeV_cfi_evtgen130.py nevts:30000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:pp_GENSIM_pthat90.root'),
...
process.D0Daufilter = cms.EDFilter("PythiaMomDauFilter",
    ...
    MomMinPt = cms.untracked.double(90.0),
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('treefile_pthat90.root')
                                                                      )
