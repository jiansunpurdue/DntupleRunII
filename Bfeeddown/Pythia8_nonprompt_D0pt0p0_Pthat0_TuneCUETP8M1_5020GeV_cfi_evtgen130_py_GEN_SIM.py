...
# with command line options: Configuration/Generator/python/Pythia8_nonprompt_D0pt0p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130.py --fileout file:pp_GENSIM_pthat0.root --eventcontent=RAWSIM --datatier GEN-SIM --step GEN,SIM --conditions auto:mc --processName GENERATOR python_filename pthat0.py --no_exec -n 30000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/Pythia8_nonprompt_D0pt0p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130.py nevts:30000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:pp_GENSIM_pthat0.root'),
