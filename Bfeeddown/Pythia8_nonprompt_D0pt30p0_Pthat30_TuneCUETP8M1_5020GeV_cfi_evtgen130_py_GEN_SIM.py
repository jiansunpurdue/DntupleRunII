...
# with command line options: Configuration/Generator/python/Pythia8_nonprompt_D0pt30p0_Pthat30_TuneCUETP8M1_5020GeV_cfi_evtgen130.py --fileout file:pp_GENSIM_pthat30.root --eventcontent=RAWSIM --datatier GEN-SIM --step GEN,SIM --conditions auto:mc --processName GENERATOR python_filename pthat30.py --no_exec -n 30000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/Pythia8_nonprompt_D0pt30p0_Pthat30_TuneCUETP8M1_5020GeV_cfi_evtgen130.py nevts:30000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:pp_GENSIM_pthat30.root'),
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('treefile_pthat30.root')
                                                                      )
